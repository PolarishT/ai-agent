...
public class ProductQueryConditionMerger {
    ...
    private ProductQueryCondition inheritFromPrevious(ProductQueryCondition current, ProductQueryCondition previous) {
        ...
        return new ProductQueryCondition(
                ...
                pickPreferringCurrent(current.comparisonTargetTexts(), previous.comparisonTargetTexts()),
                pickPreferringCurrent(current.compareFocus(), previous.compareFocus()),
                pickPreferringCurrent(current.requestedDimensions(), previous.requestedDimensions()),
